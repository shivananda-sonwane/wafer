from raw_data_pred_validation_py import raw_data_pred_validation
from app_logger.logger import logger
class pred_validation:
    """
    Predicting validation is going on each csv files using different other classes
    as specified.
    ...
    def __init__(self,file_log,path):
        ...
        self.raw_data=raw_data_pred_validation("raw_data_pred_validation.txt",path)
        self.path=path
